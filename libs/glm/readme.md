...
- Clarified refract valid range of the size of refraction, between -1 and 1 inclusively #806
...
- Fixed missing vec1 overload to length_squared and distance2 functions #431
...
#### Deprecation:
- Removed integer specification for 'icosphere' in GTC_integer #308
