...
#			if GLM_CONFIG_CTOR_INIT == GLM_CTOR_INITIALISATION
				this->m_val[0] = col_type(1, 0);
				this->m_val[1] = col_type(0, 1);
				this->m_val[2] = col_type(0, 0);
#			endif
		}
#	endif
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(s, 0);
			this->m_val[1] = col_type(0, s);
			this->m_val[2] = col_type(0, 0);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(x0, y0);
			this->m_val[1] = col_type(x1, y1);
			this->m_val[2] = col_type(x2, y2);
#		endif
	}
