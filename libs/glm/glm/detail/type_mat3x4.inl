...
#			if GLM_CONFIG_CTOR_INIT == GLM_CTOR_INITIALISATION
				this->m_val[0] = col_type(1, 0, 0, 0);
				this->m_val[1] = col_type(0, 1, 0, 0);
				this->m_val[2] = col_type(0, 0, 1, 0);
#			endif
		}
#	endif
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(s, 0, 0, 0);
			this->m_val[1] = col_type(0, s, 0, 0);
			this->m_val[2] = col_type(0, 0, s, 0);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(x0, y0, z0, w0);
			this->m_val[1] = col_type(x1, y1, z1, w1);
			this->m_val[2] = col_type(x2, y2, z2, w2);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(v0);
			this->m_val[1] = col_type(v1);
			this->m_val[2] = col_type(v2);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(m[0]);
			this->m_val[1] = col_type(m[1]);
			this->m_val[2] = col_type(m[2]);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(m[0], 0, 0);
			this->m_val[1] = col_type(m[1], 0, 0);
			this->m_val[2] = col_type(0, 0, 1, 0);
#		endif
	}
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
			this->m_val[0] = col_type(m[0], 0);
			this->m_val[1] = col_type(m[1], 0);
			this->m_val[2] = col_type(m[2], 0);
#		endif
	}
